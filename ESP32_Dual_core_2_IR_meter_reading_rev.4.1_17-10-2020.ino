...
#define INTERVAL_MESSAGE3 20000   // 1 Houre will send to google sheet
char aux_str[100];
int lengthOfJSON;
char thingsboard_url[] = "demo.thingsboard.io";
char port[] = "80";                    // PORT Connected on
String getStr = "";
String AccessToken = "kgVF47JnrEVJCND1aymm";   //For Device B nl9QWJJgi9DyutmaGCao
...
int isStickerPin = 34;///15;  // This is our input pin
